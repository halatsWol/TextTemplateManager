...
- **Browser connector (beta)** — an opt-in local API a companion browser extension ([TTM-Connect](https://github.com/halatsWol/TTM-Connect)) can call to list and paste templates ([API docs](docs/BrowserConnectorApi.md)). Available on:
